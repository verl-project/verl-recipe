    ...
    def _auto_save(self):
        ...
        while True:
            with self._lock:
                ...
                finished = sum([1 for _, req_info in self.index_prompt_tokens.items() if req_info.get("finished", False)==True])
...
class FaultMgr:
    ...
    def bind_trainer(cls, trainer):
        from recipe.fault_recover.agent_loop.fault_recover_agent_loop import FaultRecoverAgentLoopManager as AgentLoopManager
