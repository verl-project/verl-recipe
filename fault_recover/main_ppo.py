...
from verl.trainer.main_ppo import create_rl_dataset, create_rl_sampler, TaskRunner
...
def run_ppo(config, task_runner_class=None) -> None:
    ...
    if task_runner_class is None:
        task_runner_class = ray.remote(num_cpus=1)(FaultRecoverTaskRunner)  # please make sure main_task is not scheduled on head
