#!/usr/bin/env bash
# Experimental W4A8 numerical simulation (FP4 weights + FP8 activations) for Qwen3-30B-A3B-Base
set -euxo pipefail
project_name='DAPO-NVFP4-QAT'
exp_name=${exp_name:-'DAPO-Qwen3-30B-A3B-Base-W4A8-SIM'}
...
# QAT Configuration — W4A8 simulation reuses the W4A16 packed-weight format.
# verl derives FP8 activation simulation from qat_mode; no extra rollout flag is required.
qat_enable=True
qat_mode=w4a8
